...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="p-3 mb-2 bg-body-secondary">
        ...
        <tr class="">
            <td><img src="uploads/{{$product->image}}" width="100" alt=""> </td>
            ...
            <td><a href="{{route('product.destroy',$product->id)}}"class="link-offset-2 link-underline link-underline-opacity-0"><button type="button" class="btn btn-danger" >delete</a></button>
